...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    foreach ($jenis_hak_list as $jenis_hak) {
        // Pastikan kolom id adalah UUID jika digunakan atau dibiarkan NULL jika AUTO_INCREMENT
        $sql = "INSERT INTO peminjaman_warkah (id, tanggal_hari, tanggal_pinjam, tanggal_kembali, jenis_hak, keterangan, file_keterangan, nama_peminjam, tanda_tangan, status) 
                VALUES (UUID(), '$tanggal_hari', '$tanggal_pinjam', $tanggal_kembali, '$jenis_hak', '$keterangan', '$file_keterangan', '$nama_peminjam', '$tanda_tangan', '$status')";
