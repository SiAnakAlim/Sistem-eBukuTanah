...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($_POST['tanda_tangan'])) {
        ...
        $tanda_tangan = "uploads_su/ttd_" . time() . ".png";
    ...
    foreach ($jenis_hak_list as $jenis_hak) {
        $sql = "INSERT INTO peminjaman_su (tanggal_hari, tanggal_pinjam, tanggal_kembali, jenis_hak, keterangan, file_keterangan, nama_peminjam, tanda_tangan, status) 
