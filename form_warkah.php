...
<head>
    ...
    <title>Form Peminjaman Surat Ukur</title>
...
<body>
    <div class="container mt-5">
        <h2 class="mb-4">Form Peminjaman Warkah</h2>
        <form action="proses_peminjaman_warkah.php" method="POST" enctype="multipart/form-data">
    ...
    <small class="input-info">Tanggal yang terpilih akan otomatis disesuaikan dengan hari ini.</small>
            ...
            <div class="mb-3">
                <label for="jenis_hak" class="form-label"> Nomor 208 <span class="text-danger">*</span></label>
            ...
            <div class="mb-3">
                <label for="keterangan" class="form-label">Keterangan & Jumlah</label>
    ...
    // Mengisi input tanggal dengan tanggal hari ini saat halaman dimuat
    window.addEventListener('DOMContentLoaded', () => {
        const tanggalPinjam = document.getElementById('tanggal_pinjam');
        tanggalPinjam.value = getTodayDate();
    });
</script>
