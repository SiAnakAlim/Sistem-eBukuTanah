...
$query = "SELECT * FROM peminjaman_su WHERE id = $id";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Query update data
    $update_query = "UPDATE peminjaman_su SET 
...
<div class="container mt-4">
    <h1>Edit Data Peminjaman Surat Ukur</h1>
    <a href="tabel_su.php" class="btn btn-secondary mb-3">Kembali</a>

    <form action="update_su.php?id=<?php echo $id; ?>" method="POST" enctype="multipart/form-data">
        <div class="mb-3">
